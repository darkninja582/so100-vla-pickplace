...
class SerialMotorsBus(MotorsBusBase):
    ...
    def set_half_turn_homings(
        ...
        actual_positions = {motor: self.read("Present_Position", motor, normalize=False) for motor in motor_names}
    ...
    def record_ranges_of_motion(
        ...
        start_positions = {motor: self.read("Present_Position", motor, normalize=False) for motor in motor_names}
        mins = start_positions.copy()
        maxes = start_positions.copy()

        user_pressed_enter = False
        while not user_pressed_enter:
            positions = {motor: self.read("Present_Position", motor, normalize=False) for motor in motor_names}
